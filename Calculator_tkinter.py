...
class Calculator:
    def __init__(self, cal):
        ...
        self.entry_value = ''
        Entry(width=20, bg='#FFA500', font=('Arial Bold', 28), textvariable=self.equation).place(x=0, y=0)  # Light orange background
        ...
        Button(width=11, height=4, text='8', relief='flat', bg='black', fg='white', command=lambda: self.show(8)).place(x=90, y=275)
        Button(width=11, height=4, text='9', relief='flat', bg='black', fg='white', command=lambda: self.show(9)).place(x=180, y=275)
        ...
        Button(width=11, height=4, text='x', relief='flat', bg='black', fg='white', command=lambda: self.show('*')).place(x=270, y=50)
        ...
        Button(width=11, height=4, text='C', relief='flat', bg='black', fg='white', command=self.clear).place(x=0, y=350)
...
root = Tk()
calc = Calculator(root)  # Create instance of Calculator class
root.mainloop()
